...
console.log('===========================================================================')
console.log(`O valor do calculo da Área da base da Piramide é de: ${areaB.toFixed(3)}`)
console.log(`O valor do calculo da Área da lateral da Piramide é de: ${areaL.toFixed(3)}`)
console.log(`O valor do calculo do Apotema da Base é de: ${apotemaB.toFixed(3)}`)
console.log(`O valor do calculo do Apotema da Piramide é de: ${apotemaP.toFixed(3)}`)
console.log(`O valor do calculo do Volume é de: ${volume.toFixed(3)}`)
console.log('===========================================================================')
console.log('')
